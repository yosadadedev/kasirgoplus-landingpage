        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-5 py-2.5 bg-[#3958A3] hover:bg-[#304c8d] text-white rounded-full transition-all font-medium text-base shadow-[0_10px_25px_-8px_rgba(57,88,163,0.55)] hover:shadow-[0_12px_30px_-8px_rgba(57,88,163,0.7)] hover:-translate-y-0.5"
            >
